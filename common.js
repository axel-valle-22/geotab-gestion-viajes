...
+ '#gv-header-row{display:flex;gap:18px;margin-bottom:18px;align-items:stretch;flex-wrap:wrap}'
...
+ '#gv-header-row #gv-header{margin-bottom:0;flex:2;min-width:280px}'
+ '.gv-events-col{flex:1;min-width:240px;position:relative}'
+ '.gv-events-mini{background:#fff;border:1px solid var(--gv-border);border-radius:var(--gv-radius-lg);box-shadow:var(--gv-shadow);padding:14px 16px;position:relative;height:100%;box-sizing:border-box}'
...
+ '.gv-events-expanded{position:absolute;top:calc(100% + 6px);left:0;right:0;background:#fff;border:1px solid var(--gv-border);border-radius:var(--gv-radius-lg);box-shadow:var(--gv-shadow-md);padding:0 16px;max-height:0;overflow:hidden;opacity:0;pointer-events:none;transition:max-height .22s ease,opacity .18s ease,padding .22s ease;z-index:80}'
+ '.gv-events-col:hover .gv-events-expanded{max-height:480px;opacity:1;pointer-events:auto;overflow-y:auto;padding:14px 16px}'
