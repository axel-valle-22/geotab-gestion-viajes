...
+ '#gv-header-row{display:flex;gap:18px;margin-bottom:18px;align-items:flex-start;flex-wrap:wrap}'
  ...
  + '#gv-header-row #gv-header{margin-bottom:0;flex:0 0 360px;width:360px;box-sizing:border-box}'
          + '.gv-events-col{flex:1 1 420px;min-width:320px;position:relative}'
          ...
          + '.gv-events-list-wrap{position:relative;height:90px}'
          + '#gv-events-mini-list{position:absolute;top:0;left:0;right:0;max-height:90px;overflow:hidden;transition:max-height .25s ease,box-shadow .25s ease;background:#fff;z-index:5;border-bottom-left-radius:var(--gv-radius-lg);border-bottom-right-radius:var(--gv-radius-lg)}'
          + '.gv-events-mini:hover #gv-events-mini-list{max-height:420px;overflow-y:auto;box-shadow:0 16px 32px rgba(0,0,0,.18);padding-bottom:10px}'
