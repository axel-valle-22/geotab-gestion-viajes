...
+ '#gv-header{background:linear-gradient(135deg,#00AEEF,#0077A3);color:#fff;padding:20px 24px;border-radius:12px;margin-bottom:16px}'
...
+ '.gv-tab-btn:hover{background:#f3f4f6;color:#374151}.gv-tab-btn.gv-active{background:#00AEEF;color:#fff}'
...
+ '.gv-stat-num{font-size:2rem;font-weight:700;color:#00AEEF}.gv-stat-num.gv-blue{color:#0891b2}.gv-stat-num.gv-green{color:#059669}.gv-stat-num.gv-red{color:#dc2626}'
...
+ '.gv-plate-box{background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:10px 8px;display:flex;flex-direction:column;align-items:center;justify-content:center;min-width:76px;text-align:center;box-shadow:0 1px 3px rgba(0,0,0,.05)}'
...
+ '.gv-stop-chip.gv-carga{border-color:#00AEEF;color:#00AEEF;background:#eff6ff}'
...
+ '.gv-btn-primary{background:#00AEEF;color:#fff}.gv-btn-primary:hover{background:#0090c9}'
...
+ '.gv-form-card h2{margin:0 0 20px;font-size:1.2rem;color:#00AEEF}'
...
+ '.gv-form-row input:focus,.gv-form-row select:focus,.gv-form-row textarea:focus{outline:none;border-color:#00AEEF;box-shadow:0 0 0 3px rgba(0,174,239,.15)}'
...
+ '.gv-modal h3{margin:0 0 14px;color:#00AEEF;font-size:1.1rem}'
...
+ '.gv-tipo-toggle button.gv-sel-carga{background:#dbeafe;border-color:#00AEEF;color:#00AEEF}'
...
+ '.gv-wizard-step h4{margin:0 0 10px;font-size:.95rem;color:#00AEEF}'
...
+ '.gv-wizard-progress span.gv-done{background:#00AEEF}'
...
+ '.gv-view-btn.gv-active{background:#00AEEF;color:#fff;border-color:#00AEEF}'
...
+ '.gv-cal-day:hover{border-color:#00AEEF}'
+ '.gv-cal-day.gv-cal-empty{background:transparent;border:none;cursor:default}'
+ '.gv-cal-day.gv-cal-today{border-color:#00AEEF;box-shadow:0 0 0 2px rgba(0,174,239,.15)}'
+ '.gv-cal-day.gv-cal-sel{background:#eff6ff;border-color:#00AEEF}'
+ '.gv-cal-daynum{font-size:.76rem;font-weight:700;color:#374151}'
+ '.gv-cal-count{font-size:1.05rem;font-weight:700;color:#00AEEF;margin-top:6px}'
...
+ '.gv-live-marker-lbl{background:#00AEEF;color:#fff;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;font-size:14px;border:2px solid #fff;box-shadow:0 0 0 4px rgba(0,174,239,.3),0 1px 4px rgba(0,0,0,.4);animation:gvLivePulse 1.6s infinite}'
+ '@keyframes gvLivePulse{0%{box-shadow:0 0 0 4px rgba(0,174,239,.3),0 1px 4px rgba(0,0,0,.4)}50%{box-shadow:0 0 0 8px rgba(0,174,239,.05),0 1px 4px rgba(0,0,0,.4)}100%{box-shadow:0 0 0 4px rgba(0,174,239,.3),0 1px 4px rgba(0,0,0,.4)}}'+'.gv-vehicle-marker{transition:transform 1s linear}'+'.gv-live-banner{display:inline-block;padding:4px 10px;border-radius:6px;font-size:.78rem;font-weight:700;margin:4px 0}'+'.gv-live-moving{background:#d1fae5;color:#065f46}'+'.gv-live-stopped{background:#fef3c7;color:#78350f}'+'.gv-live-nocomm{background:#fee2e2;color:#991b1b}'+'.gv-live-unknown{background:#f3f4f6;color:#6b7280}';
