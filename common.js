...
+ '#gv-header-row{display:flex;gap:18px;margin-bottom:18px;align-items:flex-start;flex-wrap:wrap}'
  ...
  + '#gv-header-row #gv-header{margin-bottom:0;flex:0 0 360px;width:360px;box-sizing:border-box}'
  + '.gv-events-col{flex:0 0 360px;width:360px;position:relative}'
+ '.gv-events-mini{background:#fff;border:1px solid var(--gv-border);border-radius:var(--gv-radius-lg);box-shadow:var(--gv-shadow);padding:14px 16px;position:relative;width:100%;box-sizing:border-box}'
  ...
  + '#gv-events-mini-list{max-height:90px;overflow:hidden}'
  ...
  + '.gv-events-expanded{position:absolute;top:calc(100% + 6px);left:0;width:300%;max-width:90vw;background:#fff;border:1px solid var(--gv-border);border-radius:var(--gv-radius-lg);box-shadow:var(--gv-shadow-md);padding:0 16px;max-height:0;overflow:hidden;opacity:0;pointer-events:none;transition:max-height .22s ease,opacity .18s ease,padding .22s ease,width .22s ease;z-index:80}'
  + '.gv-events-col:hover .gv-events-expanded{max-height:420px;opacity:1;pointer-events:auto;overflow-y:auto;padding:14px 16px}'
