...
+ '#gv-events-mini-list{max-height:90px;overflow:hidden;transition:max-height .25s ease}'
  + '.gv-events-mini:hover #gv-events-mini-list{max-height:420px;overflow-y:auto}'
